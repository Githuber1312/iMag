...
public class MyTestProducts {
    ...
    private void testInsert () {
        ...
        Product p1= new Product("laptop dell", "laptop dell cu procesor de ala s memorie tot de aia si toate alea sa te prosteasca ", 4500, 11,1 );
        Product p2= new Product("laptop apple", "laptop apple m3 cu alea bune  ", 14500, 11,1 );

        Product p3= new Product("salam pikok", "ala polonez ", 25, 12,2 );
        Product p4= new Product("apa borsec", "apa de aia cu aia  ", 3.99, 12,2 );
